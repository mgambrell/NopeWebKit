...
{
	return {
		"name":			"NopeWebkit",			// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"NopeWebkit",			// this is used to identify this plugin and is saved to the project; never change it
